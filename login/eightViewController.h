...
@interface eightViewController : UIViewController<UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
@property (strong, nonatomic)NSDictionary*num2;
