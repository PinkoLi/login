...
@interface TwentyTwo2ViewController ()
...
@implementation TwentyTwo2ViewController
...
- (void)viewDidLoad {
   ...
   // [_next setImage:[UIImage imageNamed:@"继续答题.png"] forState:UIControlStateNormal];
    ...
    if ([user objectForKey:@"english"]) {
        ...
        _lb1.text=@"41、If \"Puncture\", the angle of needle insertion was";
        _lb2.text=@"42、If \"Puncture\", was the puncture successful upon one try?";
        _lb3.text=@"43、If \"Puncture\", the length of pressing was";
        
        
        
        [_btn1 setImage:[UIImage imageNamed:@"建议拍照英文.png"] forState:UIControlStateNormal];
        [_btn2 setImage:[UIImage imageNamed:@"建议拍照英文.png"] forState:UIControlStateNormal];


        
       
        _twoArray=[[NSMutableArray alloc] initWithObjects:@"YES",@"NO",nil];
        _threeArray=[[NSMutableArray alloc] initWithObjects:@"<3minutes",@"3-5minutes",@"5-10minutes",@"≥10minutes",nil];
        _oneArray=[[NSMutableArray alloc] initWithObjects:@"<30degrees",@"30-45degrees",@"45-90degrees",@"90degrees",nil];
        ...
        [_btn1 setImage:[UIImage imageNamed:@"建议拍照.png"] forState:UIControlStateNormal];
        [_btn2 setImage:[UIImage imageNamed:@"建议拍照.png"] forState:UIControlStateNormal];
        
        _twoArray=[[NSMutableArray alloc] initWithObjects:@"是",@"否",nil];
        _threeArray=[[NSMutableArray alloc] initWithObjects:@"是",@"否",nil];
        _oneArray=[[NSMutableArray alloc] initWithObjects:@"脉冲式封管",@"平推式封管",@"脉冲式冲洗后平推封管",@"非以上",nil];
...
#pragma 第一个问题
    ...
    for (int i=0; i<_oneArray.count; i++) {
        ...
        SSCheckBoxView*cb = [[SSCheckBoxView alloc] initWithFrame:CGRectMake( index*(Button_Width-20 + Width_Space) + Start_X,  page*(Button_Height + Height_Space)+Start_Y-220, Button_Width+50, Button_Height) style:kSSCheckBoxViewStyleMono checked:NO];
        NSString *a1 = [_oneArray objectAtIndex:i];
        
        [cb setText:a1];
        
        
        [cb setStateChangedTarget:self selector:@selector(change41:)];
...
#pragma 第二个问题
    ...
    for (int i=0; i<_twoArray.count; i++) {
        ...
        [cb setStateChangedTarget:self selector:@selector(change42:)];
...
#pragma 第三个问题
    ...
    for (int i=0; i<_threeArray.count; i++) {
        ...
        SSCheckBoxView*cb = [[SSCheckBoxView alloc] initWithFrame:CGRectMake( i*(Button_Width-100 + Width_Space) + Start_X,  (Button_Height + Height_Space)+Start_Y+80, Button_Width-60, Button_Height) style:kSSCheckBoxViewStyleMono checked:NO];
        NSString *a1 = [_threeArray objectAtIndex:i];
        
        [cb setText:a1];
        
        
        [cb setStateChangedTarget:self selector:@selector(change43:)];
...
-(void)change41:(SSCheckBoxView*)cbv{
...
-(void)change42:(SSCheckBoxView*)cbv{
...
-(void)change43:(SSCheckBoxView*)cbv{
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    if (buttonIndex==0) {
        TwentyTwo2ViewController *receive = [self.storyboard instantiateViewControllerWithIdentifier:@"FourPage"];
...
//        }
    ...
    if (!isok1||!isok2||!isok3) {
        ...
        NSDictionary*num1=@{@"52.1":q1};
        NSDictionary*num2=@{@"52.2":q2};
        NSDictionary*num3=@{@"52.3":q3};
...
//        eighteenViewController *receive = [self.storyboard instantiateViewControllerWithIdentifier:@"nineteenPage"];
//
//        [self.navigationController pushViewController:receive animated:YES];
...
//        }
        ...
        //            [self.navigationController pushViewController:receive animated:YES];
                    ...
                    if (!_twentythree) {
                        ...
                        _twentythree= [self.storyboard instantiateViewControllerWithIdentifier:@"24Page"];
                    }
        ...
        //            [self.navigationController pushViewController:receive animated:YES];
                    ...
                    if (!_twentyfour) {
                        ...
                        _twentyfour= [self.storyboard instantiateViewControllerWithIdentifier:@"23Page"];
                    }
...
//        NSString*photoName=[NSString stringWithFormat:@"%d",[[photoList objectForKey:@"photoList"] integerValue]];
        ...
        _str=[[@"52.2_" stringByAppendingString:date] stringByAppendingString:@".jpg"];
    }
        else{
//            NSUserDefaults *photoList = [NSUserDefaults standardUserDefaults];
//            NSString*photoName=[NSString stringWithFormat:@"%d",[[photoList objectForKey:@"photoList"] integerValue]];
            ...
            _str=[[@"52.3_" stringByAppendingString:date] stringByAppendingString:@".jpg"];
    }
