...
- (void)viewDidLoad {
   ...
   // [_next setImage:[UIImage imageNamed:@"继续答题.png"] forState:UIControlStateNormal];
    ...
    if ([user objectForKey:@"english"]) {
        ...
        _oneArray=[[NSMutableArray alloc] initWithObjects:@"＜30度",@"30-45度",@"45-90度",@"90度",nil];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    if (buttonIndex==0) {
        eighteenViewController *receive = [self.storyboard instantiateViewControllerWithIdentifier:@"FourPage"];
...
- (IBAction)nextBtn:(id)sender {
    ...
    if (!isok1||!isok2||!isok3) {
        ...
        NSDictionary*num1=@{@"41":q1};
        NSDictionary*num2=@{@"42":q2};
