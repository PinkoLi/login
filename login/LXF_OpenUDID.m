...
NSString *  url = @"http://j.webbsn.com/bd-paqcabg/index.php/";
NSString*   format=@"application/json";

NSString *  login=@"app/user/login";
NSString *  loginOut=@"app/index/logout";
NSString*   pwRest=@"app/user/updatePwdByAuthCode";
NSString*   sendEmil=@"app/user/sendEmailAuthCode";
NSString*   researchList=@"app/index/researchList";
NSString*   getResearchInfo=@"app/index/getResearchInfo";
